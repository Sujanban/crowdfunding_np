                        ...
                        user ?
                            ...
                            <div className='flex items-center space-x-2'>
                                ...
                                <li className='hidden md:flex'>
                                    <NavLink to='/login'
                                        className='border border-green-800 hover:text-green-800 transition-all duration-400 rounded-full px-3 py-1.5'
                                    >Sign in</NavLink>
                                </li>
                            </div>
                    }
