        ...
        <div className='bg-slate-100'>
            <div className='px-4 md:px-8 py-12  flex  flex-wrap items-center justify-between mx-auto'>
                ...
                <div className='md:p-6 text-center md:text-left'>
                    ...
                    <p className='md:px-2 py-1'>Fillup your banking credentials in order to withdraw your money to the bank.</p>
                    <p className='pb-4 md:px-2 text-green-700 text-sm'>No Charge Applied</p>
