            ...
            <div className='md:grid grid-cols-2'>
                ...
                <div className='flex items-center justify-center rounded-r'>
                    <div className=' w-full text-center'>
                        <img className='w-full hidden md:grid md:h-96 object-cover' src="https://plus.unsplash.com/premium_photo-1672287578699-618ea6dbcc9e?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                    </div>
                </div>
            </div>
        </div>
