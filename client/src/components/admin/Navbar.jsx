    ...
    return (
        <div className='block h-screen top-0'>
            ...
            <ul className='pt-4 px-10 grid gap-4 '>
                <NavLink
                    className={`p-2 rounded-xl  text-md hover:bg-gray-100 hover:text-black text-slate-700 flex items-center`} to="/admin/dashboard">
                    <BiHome /><span className='px-2'>Dashboard</span>
                </NavLink>

                <NavLink className={`p-2 rounded-xl  text-md hover:bg-gray-100 hover:text-black text-slate-700 flex items-center`} to="/admin/campaigns">
                    <TbBrandCampaignmonitor /><span className='px-2'>Campaigns</span></NavLink>

                <NavLink className={`p-2 rounded-xl  text-md hover:bg-gray-100 hover:text-black text-slate-700 flex items-center`} to="/admin/categories"><MdOutlineCategory /><span className='px-2'>Category</span></NavLink>

                <NavLink className={`p-2 rounded-xl  text-md hover:bg-gray-100 hover:text-black text-slate-700 flex items-center`} to="/admin/users"><BiUser /><span className='px-2'>Users</span></NavLink>

                <NavLink className={`p-2 rounded-xl  text-md hover:bg-gray-100 hover:text-black text-slate-700 flex items-center`} to="/admin/donations"><LiaMoneyBillWaveAltSolid /><span className='px-2'>Donations</span></NavLink>
            </ul>
        </div>
    )
}
