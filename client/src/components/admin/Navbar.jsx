    ...
    return (
        <div className='block h-screen w-[250px] shadow bg-gray-100 top-0'>
            ...
            <ul className='px-4 grid gap-4 '>
                ...
                <NavLink className={`p-2 rounded-xl  text-md hover:bg-white hover:text-black text-slate-700 flex items-center`} to="/admin/campaigns">
