...
const WarningPopup = ({ setPopupVisible, id, delCategory, delCampaign }) => {
    ...
    return (
        <div className='w-full transition-opacity  backdrop-blur-sm bg-black/10 h-full fixed top-0 left-0 z-50 flex justify-center items-center'>
            <div className='popup bg-white px-4 py-2 max-w-md text-center rounded-xl shadow-xl '>
                <img className=' mx-auto' src={warning} alt="" />
                <h1 className='p-2 text-xl font-medium'>Are you sure?</h1>
                <hr />
                ...
                <hr />
                <div className='text-sm p-4 flex items-center justify-end space-x-2'>
