...
const Footer = () => {
    ...
    <div className='border-t border-slate-400'>
        <div className='  max-w-7xl mx-auto px-4 py-12'>
            <div className='grid md:grid-cols-4 gap-4'>
                <div className=''>
                    ...
                    <p className='p-2 text-sm text-slate-600'>The world's largest social fundraising platform, optimized for your charity in a more easy way</p>
                    

                </div>
                <div className=''>
                    <h1 className='py-2 font-bold'>Fundraiser for</h1>
                    <div className='text-slate-600 grid '>
                        <Link>Medical</Link>
                        <Link>Education</Link>
                ...
                <div className=''>
                    <h1 className='py-2 font-bold'>Learn more</h1>
                    <div className='text-slate-600 grid '>
        ...
        <div className='p-4 max-w-7xl mx-auto md:flex items-center justify-between border-t'>
