            ...
            <div className='  max-w-7xl mx-auto px-4 py-12'>
                <div className='md:flex justify-between '>
                    ...
                    <div className='py-2 flex gap-2'>
                        <Link><TiSocialFacebookCircular size={30} /></Link>
                        <Link><TiSocialLinkedinCircular size={30} /></Link>
                        <Link><TiSocialTwitterCircular size={30} /></Link>
                    </div>
                </div> */}
                </div>

            </div>
            <div className='p-4 max-w-7xl text-sm mx-auto md:flex items-center justify-between border-t'>
