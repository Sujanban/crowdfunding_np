            ...
            <div className='w-full max-w-7xl mx-auto'>
                <div className='px-8 py-20 flex justify-center items-center bg-yellow-600 text-center'>
                    ...
                    <div className='max-w-xl mx-auto '>
                        ...
                        <p className=''>Update your campaign details following a few simple steps.</p>
                        <div className='flex items-center justify-center'>
                            <Link to={"/editcampaign/" + id} className='m-4  ring-1 transition-all duration-300 hover:bg-green-100 bg-white bg-yelow-600 px-4 py-2 rounded text-black flex justify-center items-center'>Update Campaign<CiEdit size={15} />
                            </Link>
                        </div>
                    </div>
                </div>
