        ...
        <>
            ...
            <div className='px-2  py-8 md:py-20 max-w-7xl mx-auto'>
                ...
                <div className='py-4  md:grid grid-cols-5 gap-2'>
                    <div className='col-span-1'>
                        <div className='p-2 grid gap-4'>
                            <div className='grid gap-1 md:gap-4 w-full '>
                                <div className='py-4 md:py-0 flex items-center justify-between'>
                    ...
                    <div className='p-2 col-span-4 grid sm:grid-cols-2 lg:grid-cols-3 gap-8'>
                        {filteredCampaign
                        ...
                        {filteredCampaign && filteredCampaign.length === 0 &&
                            <h1 className='text-slate-600 font-medium'>No campaign found</h1>
                        }
                    </div>
                </div>
            </div>
