...
const CreateCampaign = () => {
  ...
  return (
    ...
    //       <div className='p'>
    //         <p>Do you want to edit campaign Details? </p>
    //         <button
    //         onClick={()=> setEditable(true)}
    //          className='px-4 py-2 rounded bg-green-600 text-white flex items-center'>Edit<CiEdit size={15}/></button>
    //       </div>



    //       <form className='p-8 py-20 shadow-md bg-white' onSubmit={handleUpdate}>
    //         <div>
