        ...
        <section class="max-w-7xl mx-auto  px-8 py-12 ">
          <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
              ...
              <p class="mb-4 text-3xl tracking-tight font-medium text-gray-900 md:text-4xl ">Something's missing.</p>
              <p class="mb-6 text-lg font-light text-gray-500">Sorry, we can't find that page. You'll find lots to explore on the home page. </p>
