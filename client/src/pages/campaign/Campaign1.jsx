            ...
            <div className='lg:p-12 lg:grid grid-cols-3 gap-4'>
                ...
                <div className='col-span-2 bg-white rounded-xl'>
                    <div className='md:px-16 md:py-16'>
                        <h2 className='hidden md:block p-2 text-xl'>Where will the funds go?</h2>
                        <p className='p-2 text-slate-600'>Choose the location where you plan to withdraw your funds.</p>
                        <form onSubmit={handleSubmit}>
                            <div className=' w-full lg:max-w-2xl px-2 md:py-4 block gap-2'>
                            ...
                            <h2 className='hidden md:block p-2 text-xl'>What best describes why you're fundraising?</h2>
                            <div className='max-w-2xl'>
                                {
                                    category.length ? category.map((item, index) =>
                                        <button
                                            onClick={() => setCampaign({ ...campaign, category: item.category })
                                            }
                                            className='focus:border-yellow-600 text-sm focus:border-2 py-2 px-4 border border-slate-400 rounded-full m-2' key={index}>{item.category}</button>
                            ...
                            <div className='p-4 block md:flex justify-end '>
                                <Link to='/create/campaign/step2' className='w-full lg:w-auto px-5 py-3 bg-slate-800 text-white rounded-md'>Continue</Link>
                            </div>
                        </form>
                    </div>
                </div>
