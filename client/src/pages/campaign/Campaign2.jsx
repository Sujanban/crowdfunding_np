            ...
            <div className='lg:p-12 lg:grid grid-cols-3 gap-4'>
                <div className='col-span-1'>
                    ...
                    <div className='p-4 md:p-8 '>
                        ...
                        <h1 className='py-6 text-3xl md:text-4xl'>How much would you like to raise?</h1>
                        <p className='text-md'>You can always change your goal as you go.</p>

                    </div>
                </div>
                <div className='h-[80vh] col-span-2 bg-white rounded-xl'>
                    <div className=' md:px-16 md:py-40 '>
                        <form className=' max-w-5xl '>
                            <div className='relative w-full lg:max-w-2xl p-4 block '>
                                <input
                                ...
                                <span className='absolute right-10 top-9 text-sm '>$USD</span>
                            </div>
                            <p className='p-4 text-sm text-slate-600'>Keep in mind that transaction fees, including credit and debit charges, are deducted from each donation.</p>
                            <div className='p-4 block md:flex justify-between '>
                                <Link to='/create/campaign/step1' className='w-full lg:w-auto px-5 py-3 bg-slate-800 text-white rounded-md'><MdArrowBack className='inline' /> Back</Link>
                                <Link to='/create/campaign/step3' className='w-full lg:w-auto px-5 py-3 bg-slate-800 text-white rounded-md'>Continue</Link>
                            </div>
                        </form>
                    </div>
                </div>
