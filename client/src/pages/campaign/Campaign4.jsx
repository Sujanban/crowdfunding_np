      ...
      <div className='lg:p-12 lg:grid grid-cols-3 gap-4'>
        <div className='col-span-1'>
          ...
          <div className='p-4 md:p-8 '>
            ...
            <h1 className='py-6 text-3xl md:text-4xl'>Tell donors why you're fundraising</h1>
            <p className='text-md'>Some ideas to help you start writing:</p>
            <li className='p-2'>Introduce yourself and what you're raising funds for</li>
            <li className='p-2'>Describe why it's important to you</li>
            <li className='p-2'>Explain how the funds will be used</li>
            ...
            <form className=' max-w-3xl '>
              <div className=' w-full lg:max-w-2xl px-4 md:py-4 block gap-2'>
                <div className='py-2 grid'>
                  <label htmlFor="" className='py-2 text-xl'>Give your fundraiser a title</label>
                  <input
                ...
                <div className='py-2 grid'>
                  <label htmlFor="" className='py-2 text-xl'>Tell your story</label>
                  <textarea
                    onChange={(e) => setCampaign({ ...campaign, campaignDescription: e.target.value })}
                    className='text-md  border border-stone-600 p-4 rounded-md'
                    type="text"
              ...
              <div className='p-4 block md:flex justify-between '>
                <Link to='/create/campaign/step3' className='w-full lg:w-auto px-5 py-3 bg-slate-800 text-white rounded-md'><MdArrowBack className='inline' /> Back</Link>
                <Link to='/create/campaign/step5' className='w-full lg:w-auto px-5 py-3 bg-slate-800 text-white rounded-md'>Continue</Link>
              </div>
            </form>
          </div>
        </div>
