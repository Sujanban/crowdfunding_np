        ...
        <>
            ...
            <div className='grid gap-12 max-w-7xl mx-auto '>
                <div className='md:grid grid-cols-2 gap-4'>
                    ...
                    <img className='max-w-[500px] mx-auto p-1.5 h-full rounded-xl bg-black' src={screenshot1} alt="" />
                </div>
                <div className='md:grid grid-cols-2 gap-4'>
                    <img className='w-[500px] mx-auto p-1.5 h-full rounded-xl bg-black' src={screenshot2} alt="" />
                    <div className='p-2 md:p-4 m-auto'>
                ...
                <div className='md:grid grid-cols-2 gap-4'>
                    ...
                    <img className='w-[500px] mx-auto p-1.5 h-full rounded-xl bg-black' src={screenshot3} alt="" />
                </div>
            </div>
            <Footer />
        </>
