            ...
            <div className='px-4 py-8 md:py-20 mx-auto max-w-7xl '>
                ...
                <div className='md:p-4 md:grid grid-cols-3 gap-4'>
                    <div className='p-4 flex space-x-4 items-center rounded  shadow'>
                        <MdCall className='text-3xl' color='green' />
                        <div>
                    ...
                    <div className='p-4 flex space-x-4 items-center rounded  shadow'>
                        <MdMap className='text-3xl' color='green' />
                        <div>
                    ...
                    <div className='p-4 flex space-x-4 items-center rounded  shadow'>
                        <IoIosMailUnread className='text-3xl' color='green' />
                        <div>
                        ...
                        <form className=''>
                            <div className=' w-full  lg:max-w-2xl md:px-4 md:py-4 block gap-2'>
                                ...
                                <div className='py-2 grid relative'>
                                    ...
                                    <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="hello@example.com" />
                                </div>
                                <div className='py-2 grid relative'>
                                    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone *</label>
                                    <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="9823 267 927" />
                                </div>
                                <div className='py-2 grid relative'>
                                ...
                                <div className='py-2 grid relative'>
                                    <input
                                        type='submit'
                                        value={'Send Message'}
                                        className='bg-green-800 cursor-pointer text-white text-sm md:text-md font-light border-stone-600 p-4 rounded-md' />
                                </div>
                            </div>
                        </form>
                    </div>
