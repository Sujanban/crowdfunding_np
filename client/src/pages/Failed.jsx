    ...
    <div>
      ...
      <div className='px-8 py-20 max-w-7xl mx-auto'>
        <div className=' text-center'>
          ...
          <h1 className='p-4 text-center text-xl md:text-3xl font-semibold'>Oh Smap!</h1>
          <p className='py-4 max-w-lg mx-auto'>It seems like the payment has Failed, Please try again latter.</p>
