            ...
            <div className='lg:p-12 lg:grid grid-cols-3 gap-4'>
                ...
                <div className='col-span-2 bg-white rounded-xl'>
                    ...
                    <div className='md:px-8 md:py-16'>
                        ...
                        <form className=' w-full lg:max-w-2xl p-4 block gap-2'>
                            <div className='py-2 grid lg:grid-cols-2 gap-2'>
                                <input className='text-md font-light border border-stone-600 p-4 rounded-md' type="text" placeholder='First Name' />
                                <input className='text-md font-light border border-stone-600 p-4 rounded-md' type="text" placeholder='Last Name' />
                            </div>
                        ...
                        <div className='p-4 block md:flex justify-end '>
                            <button className='w-full lg:w-auto px-5 py-3 bg-slate-800 text-white rounded-md'>Sign up</button>
                        </div>
                    </div>
                </div>
            </div>
