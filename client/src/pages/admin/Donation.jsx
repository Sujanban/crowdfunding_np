                            ...
                            <div className='grid grid-cols-3 gap-4'>
                                    ...
                                    <div className=''>
                                        ...
                                        <div className=' grid grid-cols-2 gap-4'>
                                            <div className='p-4 rounded-xl shadow bg-gray-50'>
                                                ...
                                                <h1 className='py-3 text-3xl font-semibold'>₹ 120,500</h1>
                                            ...
                                            <div className='p-4 rounded-xl shadow bg-emerald-50'>
                                                ...
                                                <p className='border-t py-2 flex items-center text-slate-600 text-sm'>Paid:  <h1 className='px-2 font-bold text-black'> January 01, 2023</h1></p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
                                                    ...
                                                    <tbody>
                                                        <tr className='text-slate-600 text-xs border-b'>
                                                            <td scope="col" className="py-2">Help me treat cancer</td>
                                ...
                                <div className=''>
                                    <div className='p-6 rounded-xl shadow bg-white'>
                                        <h1 className='text-sm font-bold'>User Details</h1>
