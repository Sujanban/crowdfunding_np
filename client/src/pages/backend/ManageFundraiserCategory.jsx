...
const ManageFundraiserCategory = () => {
                ...
                <div className='lg:p-12 lg:grid grid-cols-3 gap-4'>
                    <div className='col-span-1'>
                        ...
                        <div className='p-4 md:p-8 '>
                            ...
                            <h1 className='py-6 text-3xl md:text-4xl'>Manage Category</h1>
                        </div>
                    ...
                    <div className='col-span-2 bg-white rounded-xl'>
                        ...
                        <div className='md:px-8 md:py-16'>
                            <h2 className='hidden md:block p-4 text-xl'>Enter a new Category</h2>
                            <form className='' onSubmit={postCategory}>
                                ...
                                <div className='p-4 block md:flex justify-end '>
                                    <button type='submit' className='w-full lg:w-auto px-5 py-3 bg-slate-800 text-white rounded-md'>Add Category</button>
                                </div>
                                    ...
                                    dbCategories.map((category) => (
                                        <div key={category._id} className='p-4 mx-auto bg-slate-100 flex items-center justify-between '>
                                            ...
                                            <div className=' space-x-4'>
                                                ...
                                                <Link className='p-3 bg-slate-800 text-white rounded-md' to={`/editCategory/${category._id}`}>Edit</Link>
                                            </div>
...
export default ManageFundraiserCategory